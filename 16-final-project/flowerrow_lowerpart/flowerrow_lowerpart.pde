  float randomTranslateX1 = random(450, 600); // red flower 1
  float randomTranslateY1 = random(100, 400);
  float randomTranslateX2 = random(250, 500); // red flower 2
  float randomTranslateY2 = random(350, 800);
  float randomTranslateX3 = random(100, 400); // red flower 3
  float randomTranslateY3 = random(300, 700);
  float randomTranslateX4 = random(100, 400); // yellow flower 4
  float randomTranslateY4 = random(300, 800);
  float randomTranslateX5 = random(300, 600); // yellow flower 5
  float randomTranslateY5 = random(300, 700);
  float randomTranslateX6 = random(50, 350); // yellow flower 6
  float randomTranslateY6 = random(500, 700);
  float randomTranslateX7 = random(50, 150); // red flower 7
  float randomTranslateY7 = random(500, 700);
  
  float randomScale1 = random(0.6, 0.8);
  float randomScale2 = random(0.4, 0.7);
  float randomScale3 = random(0.3, 0.6);
  float randomScale4 = random(0.3, 0.8);
  float randomScale5 = random(0.3, 0.7);
